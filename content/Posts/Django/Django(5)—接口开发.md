...
## 2.在 app 应用 django_web 下新建 urls.py 添加具体接口：
...
## 3.在创建接口视图函数 view_api.py 文件，实现具体接口：
...
> 参考链接：[ Django Web接口开发  @全栈测试开发日记  ](https://www.cnblogs.com/liudinglong/p/12333665.html)
