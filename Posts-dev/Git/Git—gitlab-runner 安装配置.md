...
# http://gitlab.hison.net/
Enter the registration token:
# WDKcwQGUoXRC-NR3rUns
...
## 2.Linux 安装 gitlab-runner （请确保 Git 最新）
...
在启动后，可以通过 gitlab-runner 在Linux系统上运行脚本，编写 .gitlab-ci.yml 文件来布置任务。
